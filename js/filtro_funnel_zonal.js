...
/*FILTRO PARA PESTAÑA DE BASE DE PROSPECTOS CUANDO EL PERFIL ES ZONAL*/
$('#txttienda_filtro_base_clientes_1').change(function()
{
  ...
  {
    $( '#txtempleado_filtro_base_clientes_2' ).html( respuesta );

     $('#txtempleado_filtro_base_clientes_2').selectpicker('refresh');

  });
});

/*FILTRO PARA PESTAÑA DE MIS CLIENTES CUANDO EL PERFIL ES ZOANL */
$('#txttienda_filtro_mis_clientes_1').change(function()
{
  var el_tienda = $(this).val();
  ...
  $.post('fnsvaclient.php', { var_tienda: el_tienda} ).done( function( respuesta )
  {
    $( '#txtempleado_filtro_mis_clientes_2' ).html( respuesta );

     $('#txtempleado_filtro_mis_clientes_2').selectpicker('refresh');

  });
});

/*FILTRO PARA PESTAÑA DE EMBUDO DE VENTAS CUANDO EL PERFIL ES DE ZONAL*/
$('#txttienda_filtro_funnel_2').change(function()
{
  var el_tienda = $(this).val();
  ...
  $.post('fnsvaclient.php', { var_tienda: el_tienda} ).done( function( respuesta )
  {
    $( '#txtempleado_filtro_funnel_2' ).html( respuesta );

     $('#txtempleado_filtro_funnel_2').selectpicker('refresh');

  });
});

/*MUESTRA LOS CLIENTES DE BASE DE PROSPECTOS SEGUN LOS FILTROS PARA CUANDO EL USUARIO SEA ZONAL*/
$('#btnfiltrar_base_clientes_2').click(function(){

           //event.preventDefault();
      var zona_basepros_gerencia_ = document.querySelector('#txtzona_filtro_base_clientes_4').value,
          tienda_basepros_gerencia_ = document.querySelector('#txttienda_filtro_base_clientes_1').value,
          ejecutivo_basepros_gerencia_  =  document.querySelector('#txtempleado_filtro_base_clientes_2').value;
     ...
     /*MUESTRA LOS CLIENTES EN LA PESTAÑA MIS DE CLIENTES SEGUN LOS FILTROS PARA CUANDO EL USUARIO SEA ZONAL*/
                  $('#btnfiltrar_mis_clientes_2').click(function(){

                             //event.preventDefault();
                        var zona_mispros_gerencia_ = document.querySelector('#txtzona_filtro_mis_clientes_4').value,
                            tienda_mispros_gerencia_ = document.querySelector('#txttienda_filtro_mis_clientes_1').value,
                            ejecutivo_mispros_gerencia_  =  document.querySelector('#txtempleado_filtro_mis_clientes_2').value;
                       ...
                       Viewmoredata_zonal = function () {

                         var zona_funnel_gerencia_ = document.querySelector('#txtzona_filtro_funnel_4').value,
                             tienda_funnel_gerencia_  = document.querySelector('#txttienda_filtro_funnel_2').value,
                             carnet_funnel_gerencia_ = document.querySelector('#txtempleado_filtro_funnel_2').value,
                             inicia_periodo_funnel_gerencia_ = document.querySelector('#periodo_inicia_filtro_funnel_4').value,
                             finaliza_periodo_funnel_gerencia_  = document.querySelector('#periodo_finaliza_filtro_funnel_4').value;
                       ...
                       var buttons_zonal = Highcharts.getOptions().exporting.buttons.contextButton.menuItems;

                                             buttons_zonal.push({
                                              text: "View more data",
                                              onclick: Viewmoredata_zonal
                                              });

                       /*Crea el embudo a partir de filtros ZONAL*/
                       function fn_draw_funnel_sales_filter_zonal(valores)
                       {
                  ...
                  contextButton: {
                      menuItems: buttons_zonal
                        ...
                        /*MUESTRA EL EMBUDO DE VENTAS DEL EJECUTIVO*/
                         $('#btnfiltrar_filtro_funnel_4').click(function(event){
                          ...
                          $.ajax({
                                  ...
                                  {
                                      $('#content_funnel').html('');
                                      fn_draw_funnel_sales_filter_zonal(data);
                                  }
                                })

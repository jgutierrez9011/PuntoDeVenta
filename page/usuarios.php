...
/*$con = conexion_bd(1);
$sql = "SELECT intidempleado FROM msgsac.tblcatempleado WHERE boljefe = 't' and strcorreo = '$usuario'";
            ...
            <div class="container-fluid">
              ...
              <div class="row ">
                ...
                <div class="col-md-3 mb-3">
                  ...
                  <input type="text" class="form-control" maxlength="8" id="correo" name="correo" required>
              ...
              <textarea class="form-control text-uppercase font-italic" id="direccion" name="direccion" text="arial-label"></textarea>
              </div>

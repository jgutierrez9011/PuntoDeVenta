...
$sql = "SELECT *, to_char(a.datfechacreo,'DD/MM/YYYY') fecha_facturo,
 ...
 concat(strpnombre,' ',strsnombre,' ',strpapellido,' ',strsapellido) usuario_creo
...
left join tblcatusuario d on b.strusuariocreo = d.strcorreo
...
<body>
    <div class="centrado">
      ...
      <!--  <h1>SIX PACK</h1>
        ...
        <?php } ?>
        <p style="font-size:10px">Compra # <?php echo str_pad($row_encabezado['numerofactura'], 10 , "0", STR_PAD_LEFT) ?></p>
        <p style="font-size:10px">Fecha: <?php echo $row_encabezado['fecha_facturo'] ?></p>
				...
				<p style="font-size:10px">Proveedor: <?php echo $row_encabezado['strnombre_empresa'] ?></p>
				<p style="font-size:10px">Ingreso: <?php echo $row_encabezado['usuario_creo'] ?></p>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="producto" style="font-size:11px"><?php echo $row_detalle['intidproducto']."-".$row_detalle["strdescripcionproducto"] ?></td>

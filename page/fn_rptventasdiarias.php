...
function fn_create_temp_table($fechaini,$fechafin)
{
  try {
    ...
    $table_part1 = 'CREATE TEMPORARY TABLE temp_ventas_dia_monto';
...
function fn_script_ingresoVentas_diarias($fechaini, $fechafin)
{
  try {
    ...
    $sentencia_insert = "INSERT INTO temp_ventas_dia_monto";

    return "DROP TABLE IF EXISTS temp_ventas_dia_monto; ".$create_temp_table." ".$sentencia_insert." ".$new_setencia."; "."SELECT tipo, producto, ".$campos_fecha." FROM temp_ventas_dia_monto;";

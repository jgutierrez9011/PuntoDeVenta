...
require_once 'reg.php';
  ...
  $detalle = 0; $estado ="";
  $result = pg_query(conexion_bd(1),"SELECT * FROM public.tblcatimpuesto
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
             ...
             <h2 align="left">Listado de impuesto</h2>
             <br>
          ...
          <!--   <div class="row">
            ...
            <!--     <div class="input-group">
                ...
                <div class="col-md-8">
                       ...
                       <a href="#new" role="button" class="btn btn-primary pull-right" data-toggle="modal"><strong><i class="fa fa-plus"></i> Nuevo impuesto</strong></a>
                </div>
            </div>
          </form>
                             ...
                             while($row = pg_fetch_array($result))
                                ...
                                if($row["bolactivo"]=='t'){
                                    ...
                                    ?>
                                     ...
                                     <td align="center"><p class='small' ><?php echo $row['nombre']; ?></p>
                                     <input type="hidden" id="descripcion_<?php echo $row['intidimpuesto']; ?>" value="<?php echo $row['nombre']; ?>" />
                                     </td>
     ...
     <div class="modal-dialog modal-md">
        <div class="modal-content">
           <div class="modal-header">
               ...
               <h3 id="myModalLabel" align="center">Nuevo impuesto</h3>
           </div>
           <div class="modal-body">
             <form role="form" name="frm_add_impuesto" id="frm_add_impuesto" method="post">
               <div class="form-group">
                 <strong>Descripcion </strong><br>
                 <input type="text" id="descripcion_impuesto" name="descripcion_impuesto" placeholder="IVA 00.00 %" class="form-control" autocomplete="off" required>
               </div>
               <br>

               <div class="form-group">
                 <strong>Valor </strong><br>
                 <input type="number" id="valor_impuesto" name="valor_impuesto" class="form-control" step=".01" placeholder="00.00" autocomplete="off" required>
               </div>
               <br>

             <div class="modal-footer">
                 <button class="btn" data-dismiss="modal" aria-hidden="true"><strong>Cerrar</strong></button>
                 <button type="submit" id="btn_add_impuesto" name="btn_add_impuesto" class="btn btn-primary"><strong>Guardar</strong></button>
             </div>
             </form>
           </div>
        </div>
  ...
  <div id="update" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
       <div class="modal-content">
          <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
              <h3 id="myModalLabel" align="center">Editar impuesto</h3>
          </div>
          <div class="modal-body">
            <form role="form" name="frm_editar_impuesto" id="frm_editar_impuesto" method="post">
              <div class="form-group">
                <strong>Descripcion </strong><br>
                <input type="hidden" id="id_tipo" name="id_tipo" class="form-control" autocomplete="off" required>
                <input type="text" id="descrip_impuesto" name="descrip_impuesto" class="form-control" autocomplete="off" required>
              </div>
              <br>

              <div class="form-group">
                <strong>Valor </strong><br>
                <input type="number" id="valor_impuesto_edit" name="valor_impuesto_edit" class="form-control" step=".01" placeholder="00.00" autocomplete="off" required>
              </div>
              <br>
            ...
            <div class="modal-footer">
                <button class="btn" data-dismiss="modal" aria-hidden="true"><strong>Cerrar</strong></button>
                <button type="submit" id="btn_editar_impuesto" name="btn_editar_impuesto" class="btn btn-primary"><strong>Guardar</strong></button>
            </div>
            </form>
          </div>
       </div>
...
$(function() {
  ...
  $('#id_tipo').val(id_tipo);
  $('#descrip_impuesto').val(descripcion);
  $('#valor_impuesto_edit').val(valor);
  ...
  $( "#frm_add_impuesto" ).submit(function( event ) {
  $('#btn_add_impuesto').attr("disabled", true);
  var parametros = $(this).serialize();
   $.ajax({
      ...
      $('#btn_add_impuesto').attr("disabled", false);
      //load(1);
  ...
  $( "#frm_editar_impuesto" ).submit(function( event ) {
  $('#btn_editar_impuesto').attr("disabled", true);
  var parametros = $(this).serialize();
   $.ajax({
      type: "POST",
      url: "fnimpuesto.php",
      ...
      success: function(datos){
      $("#resultados_ajax").html(datos);
      $('#btn_editar_impuesto').attr("disabled", false);
      //load(1);
      window.setTimeout(function() {
      $(".alert").fadeTo(500, 0).slideUp(500, function(){
      $(this).remove(); location.reload();});}, 5000);

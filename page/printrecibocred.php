...
FROM public.tblcatfacturaencabezado_compra a inner join
(
    ...
    <div class="centrado">
      ...
      <!--  <h1>SIX PACK</h1>
        ...
        <p style="font-size:10px">Fecha: <?php echo $fecha_creo_recibo ?></p>
				...
				<p style="font-size:10px">Proveedor: <?php echo $row_encabezado['proveedor'] ?></p>

...
require_once 'fn_rptventasdiarias.php';
 ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
              ...
              <h3 class="page-header"><i class='fa fa-edit'></i>Buscar ingreso de ventas diarias por tipo de producto</h3>
              </section>
              <br/>

              <form role="form_buscar_facturas" method="post" action="rptventasdiarias.php">
              <div class="row">
                <div class="col-md-3">
           ...
           <br>
              ...
              /*  $fecharango = explode("-", $_POST['range']);
                ...
                $sql = fn_script_ingresoVentas_diarias($fechaini, $fechafin);

                echo "
                     <section class='content-header'>
                     <h4 class='page-header  mb-3 text-center'>Ingreso de ventas diarias por tipo de producto </br> Periodo del : ".$fechaini." al ".$fechafin."</h4>
                     </section>
                     ";

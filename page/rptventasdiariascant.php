...
require_once 'fn_rptventasdiariascant.php';
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
              ...
              <h3 class="page-header"><i class='fa fa-edit'></i>Buscar Cantidad de ventas diarias por tipo de producto</h3>
              </section>
              <br/>

              <form role="form_buscar_facturas" method="post" action="rptventasdiariascant.php">
              <div class="row">
                <div class="col-md-3">
           ...
           <br>
              ...
              /*  $fecharango = explode("-", $_POST['range']);
                ...
                /*$sql ="SELECT tipo, producto, dia1,
                      ...
                      from fn_rptventasdiarias_cantidad( '$fechaini', '$fechafin');";*/
                $sql = fn_script_ingresoVentas_cantidad($fechaini, $fechafin);

                echo "
                     <section class='content-header'>
                     <h4 class='page-header  mb-3 text-center'>Cantidad de ventas diarias por tipo de producto </br> Periodo del : ".$fechaini." al ".$fechafin."</h4>
                     </section>
                     ";

                $detalle = fill_tbl('ventas_diarias', $sql);
...
var groupColumn = 0;
var table = $('#ventas_diarias').DataTable({
        "processing": true,
        "autowidth": true,
        "columnDefs": [
        ...
        "drawCallback": function ( settings ) {
            ...
            filas.each( function ( group, i ) {
                ...
                if ( last !== group ) {
                  if(last!=null){
                    $(rows).eq( i - 1).after(
                        ...
                        <td colspan=""><strong> ${ total }  </strong></td>
                        <td colspan=""><strong> ${ total1 } </strong></td>
                        <td colspan=""><strong> ${ total2 } </strong></td>
                        <td colspan=""><strong> ${ total3 } </strong></td>
                        <td colspan=""><strong> ${ total4 } </strong></td>
                        <td colspan=""><strong> ${ total5 } </strong></td>
                        <td colspan=""><strong> ${ total6 } </strong></td>
                        <td colspan=""><strong> ${ total7 } </strong></td>
                        <td colspan=""><strong> ${ total8 } </strong></td>
                        <td colspan=""><strong> ${ total9 } </strong></td>
                        <td colspan=""><strong> ${ total10 } </strong></td>
                        <td colspan=""><strong> ${ total11 } </strong></td>
                        <td colspan=""><strong> ${ total12 } </strong></td>
                        <td colspan=""><strong> ${ total13 } </strong></td>
                        <td colspan=""><strong> ${ total14 } </strong></td>
                        <td colspan=""><strong> ${ total15 } </strong></td>
                        <td colspan=""><strong> ${ total16 } </strong></td>
                        <td colspan=""><strong> ${ total17 } </strong></td>
                        <td colspan=""><strong> ${ total18 } </strong></td>
                        <td colspan=""><strong> ${ total19 } </strong></td>
                        <td colspan=""><strong> ${ total20 } </strong></td>
                        <td colspan=""><strong> ${ total21 } </strong></td>
                        <td colspan=""><strong> ${ total22 } </strong></td>
                        <td colspan=""><strong> ${ total23 } </strong></td>
                        <td colspan=""><strong> ${ total24 } </strong></td>
                        <td colspan=""><strong> ${ total25 } </strong></td>
                        <td colspan=""><strong> ${ total26 } </strong></td>
                        <td colspan=""><strong> ${ total27 } </strong></td>
                        <td colspan=""><strong> ${ total28 } </strong></td>
                        <td colspan=""><strong> ${ total29 } </strong></td>
                        <td colspan=""><strong> ${ total30 } </strong></td>
                        </tr>`
                    );
                    total=0;
                    total1=0;
                ...
                total30+=+$(rows).eq( i ).children()[31].textContent;

...
/*  $fecharango = explode("-", $_POST['range']);
  ...
  $sql="SELECT
        ...
        /*((b.numcantidad * b.numprecioventa - ((b.numcantidad * b.numprecioventa) * (coalesce(b.numdescuento,0)) )) -
        ((b.numcantidad * b.numprecioventa - ((b.numcantidad * b.numprecioventa) * (coalesce(b.numdescuento,0)) )) * (coalesce(a.numdescuentovalor,0) ) )) + (b.numcantidad * b.numprecioventa) * coalesce(a.numimpuestovalor,0)*/
       ROUND(  ( (( b.numcantidad * b.numprecioventa ) - ( (b.numcantidad * b.numprecioventa) * coalesce(b.numdescuento,0) + (b.numcantidad * b.numprecioventa) * coalesce(a.numdescuentovalor,0) )) + ((b.numcantidad * b.numprecioventa
/*DESCUENTO*/
- ((b.numcantidad * b.numprecioventa) * coalesce(b.numdescuento,0) + (b.numcantidad * b.numprecioventa) * coalesce(a.numdescuentovalor,0))
) * coalesce(a.numimpuestovalor,0.0))  ),2)
        ingreso_ventas,
        b.numcosto * b.numcantidad costo_ventas,
        ((b.numcantidad * b.numprecioventa - ((b.numcantidad * b.numprecioventa) * (coalesce(b.numdescuento,0)) )) - ((b.numcantidad * b.numprecioventa - ((b.numcantidad * b.numprecioventa) * (coalesce(b.numdescuento,0)) )) * (coalesce(a.numdescuentovalor,0) ) )) - (b.numcosto * b.numcantidad) utilidad,
        ...
        where b.datfechacreo::date between '$fechaini'  and '$fechafin'";
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
             ...
             <h4 align="center">Vista de administrador</h4>
             <br>
                  ...
                  <thead>
                    <tr>
                      ...
                      <th><p class="small"><strong>Acciones</strong></p></th>
                       ...
                       <th><p class="small"><strong>Tipo de transacción</strong></p></th>
                       ...
                       <th><p class="small"><strong>Precio unitario</strong></p></th>
                       <th><p class="small"><strong>Costo unitario</strong></p></th>
                       <th><p class="small"><strong>Cantidad</strong></p></th>
                       <th><p class="small"><strong>Ingreso ventas</strong></p></th>
                       <th><p class="small"><strong>Costo ventas</strong></p></th>
                       <th><p class="small"><strong>Utilidad</strong></p></th>
                       <th><p class="small"><strong>Tipo de factura</strong></p></th>
                          ...
                          while($row = pg_fetch_array($result))
                             {
                                 ...
                                 ?>
                                     ...
                                     <div class="btn-group pull-right">
                                      <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-expanded="false">Acciones <span class="fa fa-caret-down"></span></button>
                                       <ul class="dropdown-menu">
                                             ...
                                             <li><a href="#" onclick="view_pdf('<?php echo base64_encode($row['intidserie']) ?>');"><i class="fa fa-file-pdf-o"></i> Ver PDF</a></li>
                                  ...
                                  <td align="center"><p class='small'><?php echo $row['tipo_transaccion']; ?></p></td>
                                  <td align="center"><p class='small'><?php echo $row['cliente']; ?></p></td>

                                  <td align="center"><p class='small'><?php echo $row['descripcion']; ?></p></td>
                                  <td align="center"><p class='small'><?php echo $row['tipo']; ?></p></td>
                                  <td align="center"><p class='small'>C$ <?php echo $row['precio_unitario']; ?></p></td>
                                  <td align="center"><p class='small'>C$ <?php echo $row['costo_unitario']; ?></p></td>
                                  <td align="center"><p class='small'><?php echo $row['cantidad']; ?></p></td>
                                  <td align="center"><p class='small'>C$ <?php echo $row['ingreso_ventas']; ?></p></td>
                                  <td align="center"><p class='small'>C$ <?php echo $row['costo_ventas']; ?></p></td>
                                  <td align="center"><p class='small'>C$ <?php echo $row['utilidad']; ?></p></td>
                                  <td align="center"><p class='small'><?php echo $row['tipo_factura']; ?></p></td>

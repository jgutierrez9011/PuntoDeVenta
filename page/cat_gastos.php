...
require_once 'reg.php';
  ...
  $detalle = 0;
  $result = pg_query(conexion_bd(1),"SELECT intidclasgasto, datfechacreo fecha, strnombrecategoria categoria from tblcatgastos;");
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
             ...
             <h2 align="left">Categoría de gastos</h2>
             <br>
          ...
          <!--   <div class="row">
            ...
            <!--     <div class="input-group">
                ...
                <div class="col-md-8">
                       ...
                       <a href="#new" role="button" class="btn btn-primary pull-right" data-toggle="modal"><strong><i class="fa fa-plus"></i> Agregar categoria</strong></a>
                </div>
            </div>
          </form>
                 ...
                 <table class="table table-striped table-bordered" id="tblfacturas" style="width:100%">
                     <thead>
                       <tr>
                          ...
                          <th><p class="small"><strong>Nombre de categoría</strong></p></th>
                             ...
                             while($row = pg_fetch_array($result))
                                {
                                    ...
                                    ?>
                                     ...
                                     <td align="center">
                                          ...
                                          <input type="hidden" id="categoria_<?php echo $row['intidclasgasto']; ?>" value="<?php echo $row['categoria']; ?>" />
                                     </td>
                                     <td>
                                       ...
                                       <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-expanded="false">Acciones <span class="fa fa-caret-down"></span></button>
                                        <ul class="dropdown-menu">
                                              <li>
                                                 <a href="#update" class="edit_data" id="<?php echo $row['intidclasgasto'] ?>" data-toggle="modal"><i class="fa fa-pencil m-r-5"></i> Editar</a>
                                              </li>
     ...
     <div class="modal-dialog modal-md">
        <div class="modal-content">
           ...
           <div class="modal-body">
             <form role="form" name="frm_crear_categoria_gasto" id="frm_crear_categoria_gasto" method="post">
               <div class="form-group">
                 <strong>Nombre</strong><br>
                 <input type="text" id="nombre_categoria_gasto" name="nombre_categoria_gasto" class="form-control" autocomplete="off" required>
               </div>
               <br>
             <div class="modal-footer">
                 <button class="btn" data-dismiss="modal" aria-hidden="true"><strong>Cerrar</strong></button>
                 <button type="submit" id="guardar_cat_gasto" name="guardar_cat_gasto" class="btn btn-primary"><strong>Guardar</strong></button>
             </div>
             </form>
           </div>
        </div>
   ...
   <div id="update" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
     <div class="modal-dialog modal-md">
        <div class="modal-content">
           ...
           <div class="modal-body">
             <form role="form" name="frm_editar_categoria_gasto" id="frm_editar_categoria_gasto" method="post">
               <div class="form-group">
                 <strong>N°</strong><br>
                 <input type="text" id="id_categoria_gasto_update" name="id_categoria_gasto_update" class="form-control" readonly autocomplete="off" required>
               </div>
               <div class="form-group">
                 <strong>Nombre</strong><br>
                 <input type="text" id="nombre_categoria_gasto_update" name="nombre_categoria_gasto_update" class="form-control" autocomplete="off" required>
               </div>
               <br>
             <div class="modal-footer">
                 <button class="btn" data-dismiss="modal" aria-hidden="true"><strong>Cerrar</strong></button>
                 <button type="submit" id="btn_editar_cat_gasto" name="btn_editar_cat_gasto" class="btn btn-primary"><strong>Guardar</strong></button>
             </div>
             </form>
           </div>
        </div>
...
$(function() {
  ...
  var nombre_cuenta =   document.getElementById("categoria_"+id_cuenta).value;
  $('#id_categoria_gasto_update').val(id_cuenta);
  $('#nombre_categoria_gasto_update').val(nombre_cuenta);
  ...
  $( "#frm_crear_categoria_gasto" ).submit(function( event ) {
  $('#guardar_cat_gasto').attr("disabled", true);
  var parametros = $(this).serialize();
   $.ajax({
      ...
      $('#guardar_cat_gasto').attr("disabled", false);
      //load(1);
...
<script>
$("#frm_editar_categoria_gasto").submit(function( event ) {

$('#btn_editar_cat_gasto').attr("disabled", true);
...
var parametros = $(this).serialize();
 $.ajax({
    ...
    success: function(datos){
    $("#resultados_ajax").html(datos);
    $('#btn_editar_cat_gasto').attr("disabled", false);

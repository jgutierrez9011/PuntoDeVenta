...
function fn_create_temp_table($fechaini,$fechafin)
{
  try {
    ...
    $table_part1 = 'CREATE TEMPORARY TABLE temp_ventas_dia_monto_utilidad';
...
function fn_script_ingresoVentas_diarias_utilidad($fechaini, $fechafin)
{
  try {
    ...
    $sentencia_part2 = " FROM crosstab('
                        ...
                        COALESCE(sum((b.numcantidad * b.numprecioventa - ((b.numcantidad * b.numprecioventa) * (/*coalesce(a.numdescuentovalor,0) +*/ coalesce(b.numdescuento,0)) )) - ((b.numcantidad * b.numprecioventa - ((b.numcantidad * b.numprecioventa) * (coalesce(b.numdescuento,0)) )) * (coalesce(a.numdescuentovalor,0) /*+ coalesce(b.numdescuento,0)*/) )),0) - sum(b.numcantidad * b.numcosto) total
    ...
    $sentencia_insert = "INSERT INTO temp_ventas_dia_monto_utilidad";

    return "DROP TABLE IF EXISTS temp_ventas_dia_monto_utilidad; ".$create_temp_table." ".$sentencia_insert." ".$new_setencia."; "."SELECT tipo, producto, ".$campos_fecha." FROM temp_ventas_dia_monto_utilidad;";

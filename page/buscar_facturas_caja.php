...
$row_permiso_facturas = pg_fetch_array(pg_query(conexion_bd(1),"SELECT bolactivo
                                                                ...
                                                                where idfrmdetalle = 12 and idperfil =  $perfil"));
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
             ...
             <h4 align="center">Vista de caja</h4>
             <br>



             <form role="form_buscar_facturas" method="post" action="buscar_facturas_caja.php">
             <div class="row">
               <div class="col-md-3">
                          ...
                          while($row = pg_fetch_array($result))
                             {
                               ...
                               <tfoot>
                                  <tr>
                                      <th colspan="9" style="text-align:right">Total contado:</th>
                                      <th colspan="3">C$ <?php echo number_format($contado,2); ?> </th>
                                  </tr>

                                  <tr>
                                      <th colspan="9" style="text-align:right">Total credito:</th>
                                      <th colspan="3">C$ <?php echo number_format($credito,2); ?> </th>
                                  </tr>

                                  <tr>
                                      <th colspan="9" style="text-align:right">Total facturado:</th>
                                      <th colspan="3">C$ <?php echo number_format($ingreso,2); ?> </th>
                                  </tr>

                                  <tr>
                                      <th colspan="9" style="text-align:right">Total recibos:</th>
                                      <th colspan="3">C$ <?php echo number_format($recibos,2); ?> </th>
                                  </tr>

                                  <tr>
                                      <th colspan="9" style="text-align:right">Total ingreso:</th>
                                      <th colspan="3">C$ <?php echo number_format($recibos+$contado,2); ?> </th>
                                  </tr>
